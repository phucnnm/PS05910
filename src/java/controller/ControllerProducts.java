    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Search")) {
                ...
                Product sp = new Product(code, image, name, fpri);
                ...
                float fpri = Float.parseFloat(pri);
                Products sp = new Products();
                sp.update(code, image, name, fpri);
                String url = "ControllerProducts?action=Search&txtTenSP=" + name;
                RequestDispatcher rd = request.getRequestDispatcher(url);
                rd.forward(request, response);
                ...
                float fpri = Float.parseFloat(pri);
                Products sp = new Products();
                boolean result = sp.insert(code, image, name, fpri);
                String url = "ControllerProducts?action=Search&txtTenSP=" +name;
                RequestDispatcher rd = request.getRequestDispatcher(url);
                rd.forward(request, response);
            }
